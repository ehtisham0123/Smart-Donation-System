...
function NeedySignup(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formdata.position.lat === "" || formdata.position.lng === "") {
      ...
      await axios
        .post(`${process.env.React_App_Url}/needy/signup`, fd, {
          headers: {
    ...
    <div id="content" className="mx-5">
      ...
      <form onSubmit={handleSubmit} className="needs-validation">
        <div className="row">
          ...
          {/* Number of Children */} 
          <div className="form-group col-md-3">
            <label for="familyincome">Number of Children</label>
            <input
          ...
          {/* Father Death */} 
          <div className="form-group col-md-3">
            <p style={{ marginBottom: "2px" }}>Widow / Father Death</p>
            <div className="form-check">
              <input
                className="form-check-input"
                type="radio"
