...
function EditStudent() {
  ...
  useEffect(() => {
    ...
    let getUserData = async () => {
      await axios
        .get(`${process.env.React_App_Url}/admin/students/edit/${id}`,{
          headers: {
            token: token,
          }
        })
 ...
 const handlePhoto = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formdata.country === "null") {
      ...
      await axios.put(`${process.env.React_App_Url}/admin/students/update/`, fd, {
          headers: {
            token: token,
          ...
          <div className="form-group col-md-3">
            ...
            <div className="form-check">
              <input
                ...
                value="universtry"
                onChange={handleChange}
                checked={formdata.studentof === 'universtry'}
                required
              />
            ...
            <div className="form-check">
              <input
                ...
                value="College"
                onChange={handleChange}
                checked={formdata.studentof === 'College'}
                required
              />
            ...
            <div className="form-check">
              <input
                ...
                value="School"
                onChange={handleChange}
                checked={formdata.studentof === 'School'}
                required
              />
