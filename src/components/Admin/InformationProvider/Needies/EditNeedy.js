...
function EditNeedy() {
  ...
  useEffect(() => {
    ...
    let getUserData = async () => {
      await axios
        .get(`${process.env.React_App_Url}/admin/needies/edit/${id}`,{
          headers: {
            token: token,
          }
        })
 ...
 const handlePhoto = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formdata.country === "null") {
      ...
      fd.append("widow", formdata.widow);
      fd.append("numberofchildren", formdata.numberofchildren);
      fd.append("familyincome", formdata.familyincome);
      fd.append("bothparrentsdied", formdata.bothparrentsdied);
      fd.append("elderchildage", formdata.elderchildage);
      fd.append("home", formdata.home);
      fd.append("oldEmail", oldEmail);

      await axios.put(`${process.env.React_App_Url}/admin/needies/update/`, fd, {
          headers: {
            token: token,
    ...
    <div id="content" className="mx-5">
      ...
      <form onSubmit={handleSubmit} className="needs-validation">
        <div className="row">
          ...
          {/* Elder Child Age */}    
          <div className="form-group col-md-3">
            <label for="elderchildage">Elder Child Age</label>
            <input
              name="elderchildage"
              className={`form-control input ${errors.elderchildage ? "is-invalid" : ""}`}
              type="number"
              id="elderchildage"
              placeholder="Elder Child Age"
              onChange={handleChange}
              value={formdata.elderchildage}
              required
            />
            {errors.elderchildage && <div className="invalid-feedback">{errors.elderchildage}</div>}
          </div> 
          {/* Family Income */} 
          <div className="form-group col-md-3">
          ...
          <div className="form-group col-md-3">
            ...
            <input
              ...
              className={`form-control input ${errors.numberofchildren ? "is-invalid" : ""}`}
              type="text"
              id="numberofchildren"
              ...
              required
            />
            {errors.numberofchildren && <div className="invalid-feedback">{errors.numberofchildren}</div>}
          </div>
            {/* Widow */} 
          <div className="form-group col-md-3">
            <p style={{ marginBottom: "2px" }}>Widow</p>
          ...
          <div className="form-group col-md-3">
            ...
            <div className="form-check">
              <input
                ...
                value="yes"
                onChange={handleChange}
                checked={formdata.bothparrentsdied === 'yes'}
            ...
            <div className="form-check">
              <input
                ...
                value="No"
                onChange={handleChange}
                checked={formdata.bothparrentsdied === 'No'}
                required
              />
              <label className="form-check-label" for="No" value="No">
                No
