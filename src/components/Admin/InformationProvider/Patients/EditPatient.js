...
function EditPatient() {
  ...
  useEffect(() => {
    ...
    let getUserData = async () => {
      await axios
        .get(`${process.env.React_App_Url}/admin/patients/edit/${id}`,{
          headers: {
            token: token,
          }
        })
 ...
 const handlePhoto = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formdata.country === "null") {
      ...
      fd.append("expensis", formdata.expensis);
      fd.append("hospital", formdata.hospital);
      fd.append("doctor", formdata.doctor);
      ...
      await axios.put(`${process.env.React_App_Url}/admin/patients/update/`, fd, {
          headers: {
            token: token,
      ...
      <form onSubmit={handleSubmit} className="needs-validation">
        ...
        <div className="row">
          ...
          <div className="form-group col-md-3">
            ...
            <input
              name="disease"
              className={`form-control input ${errors.disease ? "is-invalid" : ""}`}
              type="text"
              id="disease"
              placeholder="Disease"
              onChange={handleChange}
          ...
          <div className="form-group col-md-3">
            ...
            <input
              name="hospital"
              className={`form-control input ${errors.hospital ? "is-invalid" : ""}`}
              type="text"
              id="hospital"
          ...
          <div className="form-group col-md-3">
            ...
            <input
              name="doctor"
              className={`form-control input ${errors.doctor ? "is-invalid" : ""}`}
              type="text"
              id="doctor"
          ...
          {/* Expensis */} 
          <div className="form-group col-md-3">
            <label for="expensis">Total Expensis</label>
            <input
              name="expensis"
              className={`form-control input ${errors.expensis ? "is-invalid" : ""}`}
              type="number"
              id="expensis"
              placeholder="Total Expensis"
              onChange={handleChange}
              value={formdata.expensis}
              required
            />
            {errors.expensis && <div className="invalid-feedback">{errors.expensis}</div>}
          </div>
             {/* Home */} 
          <div className="form-group col-md-3">
